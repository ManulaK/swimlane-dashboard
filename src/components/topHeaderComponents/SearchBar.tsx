	...
	return (
		<form className="relative w-full max-w-md" role="search" aria-label="Search tasks" onSubmit={(e) => e.preventDefault()}>
			...
			<input
				...
				className="w-full pl-9 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-0 font-normal bg-[var(--color-bg)] border-[var(--color-border)] text-[12px] selection:text-[var(--color-gray-400)]"
				autoComplete="off"
				value={searchQuery}
